  ...
  return (
    <section className="relative">
      ...
      <div className="max-w-6xl mx-auto px-4 py-20 relative">
        <h1 className="text-3xl md:text-5xl font-bold text-neutral-100">Rantho Accommodations</h1>
        ...
        <div className="mt-10 grid md:grid-cols-2 gap-6">
          <a
            href="/student"
            className="group rounded-xl p-6 border border-neutral-800 bg-white/5 hover:bg-white/10 transition"
          >
